...
if __name__ == "__main__":
    simple_dataset_path = r"C:\project\table_ver6-third"  # 단순한 패턴 데이터셋 경로
    complex_dataset_path = r"C:\project\table_ver6_third_plus"  # 복잡한 패턴 데이터셋 경로
    output_path = r"C:\project\table_ver6_four"  # 출력 경로
