...
# 배경 색상 추가
BACKGROUND_COLORS = {
    'light': {'white': (255, 255, 255), 'light_gray': (250, 250, 250), 'beige': (245, 245, 220), 'light_yellow': (255, 255, 224)},
    'dark': {'black': (0, 0, 0), 'dark_gray': (64, 64, 64), 'navy': (0, 0, 128), 'dark_green': (0, 100, 0)}
}
