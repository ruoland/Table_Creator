# 표의 최소 및 최대 열 수
MIN_COLS, MAX_COLS = 3, 15

# 표의 최소 및 최대 행 수
MIN_ROWS, MAX_ROWS = 3, 15

# 이미지 생성 시 한 번에 처리할 이미지 수
BATCH_SIZE = 1000
...
# 생성할 이미지의 최소 너비와 높이 (픽셀 단위)
MIN_IMAGE_WIDTH, MIN_IMAGE_HEIGHT = 300, 500

# 생성할 이미지의 최대 너비와 높이 (픽셀 단위)
MAX_IMAGE_WIDTH, MAX_IMAGE_HEIGHT = 1200, 1200

# 셀 내 텍스트의 최소 폰트 크기
MIN_FONT_SIZE = 8

# 셀 크기에 대한 최대 폰트 크기의 비율
MAX_FONT_SIZE_RATIO = 1.0

# 셀 내 텍스트 주변의 여백 비율
TEXT_PADDING_RATIO = 0.1 

# 셀 병합 확률
CELL_MERGE_PROBABILITY = 0.5

# 최대 병합 셀 크기 (행, 열)
MAX_MERGE_SIZE = (5, 5)

# 표 테두리 스타일 (실선, 점선, 이중선 등)
BORDER_STYLES = ['solid', 'dotted', 'double']

# 열 너비 비율 (불균일한 열 너비를 위해)
COLUMN_WIDTH_RATIOS = [1, 1.5, 2, 2.5]

# 행 높이 비율 (불균일한 행 높이를 위해)
ROW_HEIGHT_RATIOS = [1, 1.2, 1.5]

# [불완전한 표 전용] 텍스트 주변에 노이즈를 추가할 확률
NOISE_PROBABILITY = 0.6

# [불완전한 표 전용] 추가할 노이즈의 최소 개수
MIN_NOISE_COUNT = 10

# [불완전한 표 전용] 추가할 노이즈의 최대 개수
MAX_NOISE_COUNT = 30

# [불완전한 표 전용] 랜덤 점을 추가할 확률
RANDOM_DOT_PROBABILITY = 0.6

# [불완전한 표 전용] 랜덤 선을 추가할 확률
RANDOM_LINE_PROBABILITY = 0.6

# [불완전한 표 전용] 추가할 랜덤 점의 최소 및 최대 개수
MIN_RANDOM_DOTS, MAX_RANDOM_DOTS = 10, 30

# [불완전한 표 전용] 추가할 랜덤 선의 최소 및 최대 개수
MIN_RANDOM_LINES, MAX_RANDOM_LINES = 2, 20

# [불완전한 표 전용] 선 끊김 확률
LINE_BREAK_PROBABILITY = 0.3

# [불완전한 표 전용] 셀 경계 흐림 확률
CELL_BLUR_PROBABILITY = 0.5
